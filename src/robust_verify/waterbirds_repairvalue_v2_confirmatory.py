"""Frozen integrity rules for Waterbirds noise-gated RepairValue-Q v2.

The design is prospectively frozen after the disclosed Waterbirds v1 failure
on seeds 20--39.  It uses fresh corruption seeds 40--59 and must never be
pooled with earlier development or confirmation blocks. Only filesystem paths
may be overridden without creating a new protocol version.
"""
...
FROZEN_SEEDS = tuple(range(40, 60))
FROZEN_METHODS = (
    "random",
    "loss",
    "noise_score",
