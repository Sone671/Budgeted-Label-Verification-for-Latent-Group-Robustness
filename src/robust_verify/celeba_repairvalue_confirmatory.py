"""Frozen integrity rules for the CelebA RepairValue-Q E2E follow-up.

This protocol is prospectively frozen after the exploratory frozen-feature
seed 0--9 screen.  It uses fresh corruption seeds 20--29 and must never be
pooled with either the exploratory screen or the TracIn seed 10--19 protocol.
Only filesystem paths may be overridden without creating a new version.
"""
...
PRIMARY_MIN_POSITIVE_PAIRED_SEEDS = 8
REPAIR_VALUE_TAIL_FRACTION = 0.20
BOOTSTRAP_REPLICATES = 10_000
BOOTSTRAP_RNG_SEED = 20260802
...
def validate_frozen_config(
    ...
    expected: dict[str, Any] = {
        ...
        "confirmation.role": "prospective_confirmatory_followup",
        "confirmation.hypothesis_origin": "exploratory_frozen_feature_seeds_0_9",
    ...
    if problems:
        raise ValueError("Frozen CelebA RepairValue protocol mismatch:\n- " + "\n- ".join(problems))
...
def summarize_confirmatory_results(frame: pd.DataFrame) -> dict[str, Any]:
    """Apply the registered paired RepairValue-vs-Loss success gate."""
    ...
    gates = {
        ...
        "positive_paired_seed_count_at_least_8": bool(
