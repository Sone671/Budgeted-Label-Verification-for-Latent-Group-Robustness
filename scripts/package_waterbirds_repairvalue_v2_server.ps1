param(
    [string]$Destination = "dist/waterbirds_repairvalue_v2_seed40_59_server.zip"
)
...
$items = @(
    ...
    "LICENSE",
    "README.md",
    "WATERBIRDS_REPAIRVALUE_V2_SERVER_README.md",
    "WATERBIRDS_REPAIRVALUE_V2_EXPERIMENT_PLAN.md",
    "configs/waterbirds_e2e_repairvalue_v2_seed40_59.yaml",
    "src/robust_verify",
    "scripts/run_waterbirds_repairvalue_v2_server.py",
    "scripts/run_waterbirds_repairvalue_v2_server.sh",
    "tests/test_waterbirds_repairvalue_v2_confirmatory.py",
    "tests/test_repairvalue_v2.py",
...
$staging = Join-Path ([System.IO.Path]::GetTempPath()) (
    "waterbirds_repairvalue_v2_server_" + [guid]::NewGuid().ToString("N")
)
try {
