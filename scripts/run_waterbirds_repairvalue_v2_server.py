#!/usr/bin/env python
"""Run the frozen Waterbirds noise-gated RepairValue-Q v2 seed-40--59 protocol."""
...
DEFAULT_CONFIG = REPOSITORY_ROOT / "configs" / "waterbirds_e2e_repairvalue_v2_seed40_59.yaml"
MIN_CUDA_MEMORY_GIB = 6.0
...
def _environment() -> dict[str, Any]:
    ...
    code_paths = [
        REPOSITORY_ROOT / "src" / "robust_verify" / "waterbirds_repairvalue_v2_confirmatory.py",
